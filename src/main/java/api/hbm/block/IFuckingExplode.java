...
public interface IFuckingExplode {
    // Anything that can be detonated by another explosion should implement this and spawn an TNTPrimedBase when hit by an explosion
    ...
    void explodeEntity(Level level, double x, double y, double z, TNTPrimedBase entity);
}
