...
public abstract class MissileTier0 extends MissileBaseNT {
    ...
    public static class MissilMicro extends MissileTier0 {
        public MissilMicro(EntityType<? extends MissilMicro> entityType, Level level) { super(entityType, level); }
        @Override
    ...
    public static class MissileBHole extends MissileTier0 {
        ...
        @Override
        public void onMissileImpact(RayTraceResult mop) {
            ExplosionVNT.createExplosion(level, this, mop.hitVec.x, mop.hitVec.y, mop.hitVec.z, 5.0F, true);
    ...
    public static class MissileTaint extends MissileTier0 {
        ...
        public void onMissileImpact(RayTraceResult mop) {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                int b = random.nextInt(11) + mop.getBlockPos().getX() - 5;
                int c = random.nextInt(11) + mop.getBlockPos().getY() - 5;
                ...
                if (state.isSolidRender(level, randPos) && !state.isAir()) {
                    level.setBlock(randPos, ModBlocks.TAINT.get().defaultBlockState(), 2);
                }
            }
        }
        @Override public ItemStack getDebrisRareDrop() { return new ItemStack(ModItems.NOTHING.get()); }
