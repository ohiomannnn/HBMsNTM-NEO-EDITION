...
public abstract class RotatingParticleNT extends ParticleNT {

    public RotatingParticleNT(ClientLevel level, double x, double y, double z) {
        super(level, x, y, z);
    }

    public void renderParticleRotated(VertexConsumer consumer, Camera camera, int color, float scale, float partialTicks, int brightness) {
