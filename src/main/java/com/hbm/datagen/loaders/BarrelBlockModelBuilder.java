...
public class BarrelBlockModelBuilder extends CustomLoaderBuilder<BlockModelBuilder> {
    ...
    public BarrelBlockModelBuilder texture(String key, ResourceLocation location) {
