...
public class NukeGadgetScreen extends InfoScreen<NukeGadgetMenu> {
    ...
    public NukeGadgetScreen(NukeGadgetMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        for (String s : I18nUtil.resolveKeyArray("container.nuke_gadget.desc")) text.add(Component.literal(s));
