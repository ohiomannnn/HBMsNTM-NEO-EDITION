...
public class NukeGadgetMenu extends AbstractContainerMenu {
    ...
    public final NukeGadgetBlockEntity be;

    public NukeGadgetMenu(int id, Inventory playerInv, FriendlyByteBuf extraData) {
        this(id, playerInv, (NukeGadgetBlockEntity) playerInv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public NukeGadgetMenu(int id, Inventory inventory, NukeGadgetBlockEntity blockEntity) {
        super(ModMenuTypes.NUKE_GADGET.get(), id);
