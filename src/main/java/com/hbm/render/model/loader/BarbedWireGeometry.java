...
public class BarbedWireGeometry implements IUnbakedGeometry<BarbedWireGeometry> {
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState state, ItemOverrides overrides) {
        ...
        HFRWavefrontObject obj = new HFRWavefrontObject("models/obj/block/barbed_wire.obj");

        return new BarbedWireBakedModel(obj, textureSprite);
    }
}
