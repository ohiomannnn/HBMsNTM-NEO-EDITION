...
public class I18nUtil {
    ...
    public static String resolveKey(String s, Object... args) { return NuclearTechMod.proxy.getI18n().resolveKey(s, args); }
    public static String format(String s, Object... args) {     return NuclearTechMod.proxy.getI18n().resolveKey(s, args); } //alias
    public static boolean exist(String s) { return NuclearTechMod.proxy.getI18n().exist(s); }
    ...
    public static String[] resolveKeyArray(String s, Object... args) {
        return NuclearTechMod.proxy.getI18n().resolveKeyArray(s, args);
    }
    ...
    public static List<String> autoBreakWithParagraphs(Object fontRenderer, String text, int width) {
        return NuclearTechMod.proxy.getI18n().autoBreakWithParagraphs(fontRenderer, text, width);
    }
    ...
    public static List<String> autoBreak(Object fontRenderer, String text, int width) {
        return NuclearTechMod.proxy.getI18n().autoBreak(fontRenderer, text, width);
    }
}
